...
class PercentProvider extends ChangeNotifier{
  ...
  TextStyle percentageStyle = TextStyle(fontSize: 9,fontWeight: FontWeight.bold,color: Colors.red[200]);
  TextStyle labelStyle = TextStyle(fontSize: 9,fontWeight: FontWeight.bold,color: Colors.black26);
